...
[![](/images/flashcarts/r4isdhc-dc_small.png)]({{ base_path }}/3ds/images/flashcarts/r4isdhc-dc.png){:target="_blank"}
{: .text-center}
{: .notice--info}
...
1. Распакуйте содержимое архива с ядром в корень SD-карты флеш-картриджа, таким образом, чтобы файл `r4.dat` находился в корне карты 
	...
	![]({{ base_path }}/3ds/images/screenshots/r4.png){:target="_blank"}
	{: .text-center}
	{: .notice--info}
